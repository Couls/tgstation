...
/obj/vehicle/ridden/scooter/wrench_act(mob/living/user, obj/item/I)
	...
	if(I.use_tool(src, user, 40, volume=50))
		var/obj/vehicle/ridden/scooter/skateboard/improvised/S = new(drop_location()[1])
		new /obj/item/stack/rods(drop_location()[1], 2)
...
/obj/item/scooter_frame/wrench_act(mob/living/user, obj/item/I)
	...
	new /obj/item/stack/rods(drop_location()[1], 10)
...
/obj/vehicle/ridden/scooter/skateboard/improvised/screwdriver_act(mob/living/user, obj/item/I)
	...
	if(I.use_tool(src, user, 20, volume=50))
		...
		new /obj/item/stack/sheet/metal(drop_location()[1], 5)
		new /obj/item/scooter_frame(drop_location()[1])
		if(has_buckled_mobs())
			var/mob/living/carbon/H = buckled_mobs[1]
			unbuckle_mob(H)
		qdel(src)
